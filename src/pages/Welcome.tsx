    ...
    <>
      ...
      <main className="h-screen w-screen bg-spacebg bg-no-repeat bg-local bg-cover bg-bottom">
        ...
        <div className="h-full w-full flex justify-center items-center relative">
          {/* Main wrapper */}
          <div className="h-full w-full flex flex-col items-start justify-end text-center border-2 border-red-400">
            {/* Main text */}
            <div className=" w-full h-full flex flex-col items-start justify-end ml-10">
              {/* Title */}
              <div className="h-[21.875rem] w-[35rem] bottom-20 relative inset-0">
